    ...
    <>
      <div className="w-full bg-black text-white px-4 py-3 flex items-center justify-between shadow-md">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a href="/" className="hover:text-pink-400 font-serif">
            Home
          </a>
          <a href="/about" className="hover:text-pink-400 font-serif">
            About me
          </a>
          <a href="/services" className="hover:text-pink-400 font-serif">
            Service
          </a>
          <a href="/portfolio" className="hover:text-pink-400 font-serif">
            Portfolio
          </a>
          <a href="/contact" className="hover:text-pink-400 font-serif">
            Contact
          </a>
        </div>  
      ...
      {isOpen && (
        <div className="bg-black text-white px-4 py-2 flex flex-col gap-4 md:hidden">
          ...
          <a href="/login" className="hover:text-pink-400 font-serif">
            Contact
          </a>
          <button
            onClick={() => {
